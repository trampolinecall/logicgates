...
impl UI {
    pub(crate) fn new() -> UI {
        ...
        let mut rects: Vec<_> = (0..20)
            ...
            .collect();
        rects.push(Box::new(widgets::slider::Slider::new(&mut id_maker, Some(1.0), Some(20.0), |logic_gates| logic_gates.subticks_per_update, crate::Message::NumberOfSubticksPerUpdateChanged)));
