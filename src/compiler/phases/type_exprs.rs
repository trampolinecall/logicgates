...
impl<'file> From<(&ty::TypeContext<named_type::FullyDefinedStruct<'file>>, NoField<'file>)> for CompileError<'file> {
    fn from((types, NoField { ty, field_name_sp, field_name }): (&ty::TypeContext<named_type::FullyDefinedStruct<'file>>, NoField<'file>)) -> Self {
...
fn type_expr<'file>(
    type_context: &mut ty::TypeContext<named_type::FullyDefinedStruct<'file>>,
