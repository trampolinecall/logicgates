...
impl<'file, ExprTypeInfo, TypeExpr> CircuitOrIntrinsic<'file, ExprTypeInfo, ty::TypeSym, TypeExpr> {
    pub(crate) fn input_type(&self, type_context: &mut ty::TypeContext<named_type::FullyDefinedStruct>) -> ty::TypeSym {
        match self {
...
impl<'file, ExprTypeInfo, PatTypeInfo> CircuitOrIntrinsic<'file, ExprTypeInfo, PatTypeInfo, (Span<'file>, ty::TypeSym)> {
    pub(crate) fn output_type(&self, type_context: &mut ty::TypeContext<named_type::FullyDefinedStruct>) -> ty::TypeSym {
        match self {
