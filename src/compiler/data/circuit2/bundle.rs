...
impl ProducerBundle {
    pub(crate) fn type_(&self, type_context: &mut ty::TypeContext<named_type::FullyDefinedStruct>) -> ty::TypeSym {
        match self {
...
impl ReceiverBundle {
    pub(crate) fn type_(&self, _: &mut ty::TypeContext<named_type::FullyDefinedStruct>) -> ty::TypeSym {
